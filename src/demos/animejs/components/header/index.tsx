...
export default function Header({ isHome = true }: HeaderProps) {
  ...
  return (
    <header
      id='site-header'
      className='sticky top-0 z-[105] px-[var(--margin-s)] bg-transparent max-w-[1500px] w-full flex flex-wrap animejs-lg:z-[2] animejs-lg:px-[var(--margin-m)]'
      style={{ backgroundColor: headerBg }}
    >
      <div
        id='site-header-content'
        className='static z-[2] flex justify-between items-center w-full border-b border-transparent animejs-lg:border-b-transparent'
        style={{ height: 'var(--site-header-height)', borderBottom: borderBottom }}
      >
        {/* Logo 区域 */}
        <h1 className='flex items-center w-[calc(100%-2.5rem)] z-[1] animejs-lg:w-[13rem]' style={{ height: 'var(--site-header-height)' }}>
          <a href='/' className='flex items-center h-full'>
            <img src={LOGO_URL} alt='anime.js logo v4' width='580' height='118' className='h-5 w-auto animejs-lg:h-6' />
        ...
        <nav
          id='site-menu'
          className={`overflow-scroll fixed z-[1] top-0 right-0 min-h-dvh bg-[var(--hex-bg-1)] transition-transform duration-300 animejs-lg:overflow-visible animejs-lg:relative animejs-lg:min-h-auto animejs-lg:pt-0 animejs-lg:pb-0 animejs-lg:bg-transparent animejs-lg:transform-none animejs-lg:transition-none ${menuActive ? 'translate-x-0' : 'translate-x-full'}`}
          style={{ paddingTop: 'var(--site-header-height)', paddingBottom: 'calc(var(--site-header-height) + var(--margin-m))' }}
        >
          <ul className='flex shrink-0 flex-col justify-center items-stretch list-none h-full gap-0 animejs-lg:flex-row animejs-lg:justify-start animejs-lg:items-center animejs-lg:h-auto'>
            {/* Docs */}
            <li className='flex items-center h-auto px-[var(--margin-s)] pl-[var(--margin-xxs)] animejs-lg:h-full animejs-lg:pl-0 animejs-lg:pr-0'>
              <a
                className='main-nav-link relative flex items-center px-[var(--margin-xs)] no-underline h-auto animejs-lg:h-full animejs-lg:text-inherit animejs-lg:leading-none'
                style={{ color: 'var(--hex-fg-3)', fontSize: 'var(--text-s)', lineHeight: '2em' }}
                data-id='docs'
                href='documentation.html'
                title='Documentation'
              >
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className='w-5 h-5 mr-[var(--margin-xs)] animejs-lg:mr-[-0.25em] animejs-lg:ml-[-0.25em]'>
                ...
                <span className='whitespace-pre overflow-hidden text-ellipsis inline-block animejs-lg:hidden'>Docs</span>
              </a>
            </li>
            {/* Easings */}
            <li className='flex items-center h-auto px-[var(--margin-s)] pl-[var(--margin-xxs)] animejs-lg:h-full animejs-lg:pl-0 animejs-lg:pr-0'>
              ...
              >
                <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' className='w-5 h-5 mr-[var(--margin-xs)] animejs-lg:mr-[-0.25em] animejs-lg:ml-[-0.25em]'>
                  <path fill='none' stroke='currentColor' strokeWidth='1.75' d='M4.5,17 C14.5967876,17 8.37571813,7 19.5,7' />
                </svg>
                <span className='whitespace-pre overflow-hidden text-ellipsis inline-block animejs-lg:hidden'>Easings</span>
              </a>
            </li>
            {/* Learn */}
            <li className='flex items-center h-auto px-[var(--margin-s)] pl-[var(--margin-xxs)] animejs-lg:h-full animejs-lg:pl-0 animejs-lg:pr-0'>
              ...
              >
                ...
                <span className='whitespace-pre overflow-hidden text-ellipsis inline-block animejs-lg:hidden'>Learn</span>
              </a>
            </li>
            ...
            <li className='flex items-center h-auto px-[var(--margin-s)] pl-[var(--margin-xxs)] animejs-lg:h-full animejs-lg:pl-0 animejs-lg:pr-0'>
              ...
              >
                ...
                <span className='whitespace-pre overflow-hidden text-ellipsis inline-block animejs-lg:hidden'>Examples</span>
              </a>
            </li>
            ...
            <li className='flex items-center h-auto px-[var(--margin-s)] pl-[var(--margin-xxs)] animejs-lg:h-full animejs-lg:pl-0 animejs-lg:pr-0'>
              ...
              >
                ...
                <span className='whitespace-pre overflow-hidden text-ellipsis inline-block animejs-lg:hidden'>GitHub</span>
              </a>
            </li>
            {/* Sponsor - 带有特殊背景效果 */}
            <li className='flex items-center h-auto pl-[var(--margin-xxs)] pr-[var(--margin-s)] animejs-lg:h-full animejs-lg:pl-[var(--margin-xs)] animejs-lg:pr-0'>
              <SponsorButton>
                <a
                  className='main-nav-link relative flex items-center px-[var(--margin-xs)] no-underline h-auto animejs-lg:h-full animejs-lg:text-inherit animejs-lg:leading-none animejs-lg:pl-[var(--margin-xxs)] animejs-lg:pr-[var(--margin-xxs)]'
                ...
                >
                  {/* 桌面端赞助按钮背景 */}
                  <span className='sponsor-link-bg hidden animejs-lg:block' />
                  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className='w-5 h-5 mr-[var(--margin-xs)] animejs-lg:mr-1'>
                    <g fill='none' fillRule='evenodd'>
        ...
        <button
          id='toggle-site-menu'
          className='flex justify-center items-center absolute z-[9999] top-0 right-0 h-full bg-transparent border-none shadow-none outline-none cursor-pointer animejs-lg:hidden'
