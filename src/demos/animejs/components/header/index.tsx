...
export default function Header() {
  ...
  return (
    <header
      id='site-header'
      className={`${styles['site-header']} ${styles['layout-container']} text-ui ui-overlay${menuOpen ? 'is-menu-open' : ''}`}
    >
      <div id='site-header-content' className={styles['site-header-content']}>
        ...
        <nav id='site-menu' className={`${styles['site-menu']}${menuOpen ? ` ${styles['is-open']}` : ''}`}>
          <ul>
            <li>
              <a
                className={`${styles['main-nav-link']} docs-link`}
                data-id='docs'
                ...
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className={styles.icon}>
                  <g id='sidebar' fill='none' fillRule='evenodd'>
                    <path
                      ...
                      fill='#FFFFFF'
                      fillRule='nonzero'
                      d='M16.167 6.125H7.833A3.375 3.375 0 0 0 4.458 9.5v5a3.375 3.375 0 0 0 3.375 3.375h8.334a3.375 3.375 0 0 0 3.375-3.375v-5a3.375 3.375 0 0 0-3.375-3.375zm-8.334 1.75h8.334c.897 0 1.625.728 1.625 1.625v5c0 .897-.728 1.625-1.625 1.625H7.833A1.625 1.625 0 0 1 6.208 14.5v-5c0-.897.728-1.625 1.625-1.625z'
                    />
                    <polyline
                      id='Path-42'
                      stroke='#FFFFFF'
                      strokeWidth='1.75'
                      points='9.5 7.75 9.5 12 9.5 16.25'
                      data-points='13.5 8.75 10.5 12 13.5 15.25'
                    />
                  </g>
                </svg>
                <span>Docs</span>
            ...
            <li>
              <a className={styles['main-nav-link']} href='easing-editor.html' title='Easing functions editor'>
                <svg
                ...
                >
                  <path
                    ...
                    stroke='currentColor'
                    strokeWidth='1.75'
                    d='M4.5,17 C14.5967876,17 8.37571813,7 19.5,7'
                  />
                </svg>
                <span>Easings</span>
              </a>
            ...
            <li>
              <a className={styles['main-nav-link']} href='learn.html' title='Learn'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='24'
                  height='24'
                ...
                >
                  <g fill='none'>
                    <path
                      fill='currentColor'
                      d='M16.1666667,6.125 L7.83333333,6.125 C5.9693723,6.125 4.45833333,7.63603897 4.45833333,9.5 L4.45833333,14.5 C4.45833333,16.363961 5.9693723,17.875 7.83333333,17.875 L16.1666667,17.875 C18.0306277,17.875 19.5416667,16.363961 19.5416667,14.5 L19.5416667,9.5 C19.5416667,7.63603897 18.0306277,6.125 16.1666667,6.125 Z M7.83333333,7.875 L16.1666667,7.875 C17.0641294,7.875 17.7916667,8.60253728 17.7916667,9.5 L17.7916667,14.5 C17.7916667,15.3974627 17.0641294,16.125 16.1666667,16.125 L7.83333333,16.125 C6.93587061,16.125 6.20833333,15.3974627 6.20833333,14.5 L6.20833333,9.5 C6.20833333,8.60253728 6.93587061,7.875 7.83333333,7.875 Z'
                    />
                    <path
                      fill='currentColor'
                      fillRule='evenodd'
                      d='M10,10.0706309 L10,13.9294941 C10,14.2445758 10.2554242,14.5 10.5705059,14.5 C10.6590742,14.5 10.7464261,14.479379 10.8256439,14.4397701 L14.6845071,12.5103385 C14.9663248,12.3694297 15.0805539,12.0267421 14.9396451,11.7449245 C14.8844409,11.634516 14.7949156,11.5449908 14.6845071,11.4897865 L10.8256439,9.56035488 C10.5438263,9.41944606 10.2011387,9.53367523 10.0602299,9.81549288 C10.033824,9.86830478 10.0158571,9.92473182 10.0068132,9.9827243 L10,10.0706309 Z'
                    />
                  </g>
                </svg>
                <span>Learn</span>
            ...
            <li>
              <a
                className={`${styles['main-nav-link']} nav-link-retractable`}
                ...
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className={styles.icon}>
                  <g id='codepen' fill='none' fillRule='evenodd' strokeLinecap='round' strokeLinejoin='round'>
                    <path
                      ...
                      stroke='#FFFFFF'
                      strokeWidth='1.75'
                      d='M5 14.355L12 19l7-4.645v-4.71L12 5 5 9.645v4.71zm14 0l-7-4.71-7 4.71m0-4.71l7 4.646 7-4.646M12 5v4.645m0 4.71V19'
                    />
                  </g>
                </svg>
                <span>Examples</span>
            ...
            <li>
              <SponsorButton>
                <a
                  className={`${styles['main-nav-link']} ${styles['sponsor-button']}`}
