            ...
            <div className={styles['email-signup-form']}>
              <form>
                <div className={`${styles['email-signup-fields']} ${styles['is-active']}`}>
                  <input className={`${styles['email-signup-field']} ${styles['email-signup-input']}`} type="email" name="email" placeholder="Enter your email" required />
                  <input className={`${styles['email-signup-field']} ${styles['email-signup-submit']}`} type="submit" value="Subscribe" />
                </div>
